...
namespace Korn.CLR
{
    ...
    public unsafe struct clr_MethodDesc
    {
        ...
        public static readonly int ALIGNMENT = sizeof(IntPtr);
        ...
        public bool HasNativeCode => GetNativeCode() != null;
        ...
        {
            if (GetMethodEntryPointIfExists() == null)
                EnsureTemporaryEntryPointCore();
        }

        void EnsureTemporaryEntryPointCore()
        {
            if (GetTemporaryEntryPointIfExists() == null)
    ...
    {
        static void* PreStub = (void*)((long)CoreClr.ModuleHandle + (long)UnsafeAccessOffsets.Coreclr_PreStub);
    ...
    {
        public static bool IS_ALIGNED(void* address, int value) => IS_ALIGNED((IntPtr)address, value);

        public static bool IS_ALIGNED(IntPtr address, int value) => IS_ALIGNED((int)address, value);
    ...
    public unsafe struct ArrayListInterator
    {
        public ArrayListInterator(clr_ArrayList array) => this.array = array;
    ...
    static class UnsafeAccessOffsets
    {
        public readonly static IntPtr
            Coreclr_AppDomain_m_pTheAppDomain = (IntPtr)0x488080,
            Coreclr_ClassLoader_LoadTypeDefOrRefThrowing = (IntPtr)0x27510,
            Coreclr_GetTypesInner = (IntPtr)0x96D14,
            Coreclr_PreStub = (IntPtr)0x15F050;
    }
    ...
    public unsafe struct clr_PtrArray<T> where T : unmanaged
    {
        ...
        public List<IntPtr> ToList()
        {
            ...
            var result = new List<IntPtr>(count);
            for (var i = 0; i < count; i++)
                result.Add((IntPtr)(Array + i));
    ...
    {
        static clr_AppDomain** appDomainPointer = (clr_AppDomain**)((long)CoreClr.ModuleHandle + (long)UnsafeAccessOffsets.Coreclr_AppDomain_m_pTheAppDomain);
    ...
    public unsafe struct clr_IMDInternalImport
    {
        ...
        [FieldOffset(0x10)]
        public clr_CLiteWeightStgdb LiteWeightStgdb; // clr_CMiniMd
    ...
    public unsafe struct clr_CMiniMd
    {
        ...
        public void* FindHotRow(int offset, uint token)
        {
            ...
            v4 = *((long*)self + 165) + *(int*)(*((long*)self + 165) + 4L * offset + 4);
            if (*(int*)(v4 + 4) != 0)
            {
                v5 = *(short*)(v4 + 16);
                v6 = v4 + *(uint*)(v4 + 4);
                ...
                v11 = v9;
                if (v9 >= v10)
                    return (void*)(*((long*)self + (uint)offset + 120) + token * *((ushort*)self + 8 * (uint)offset + 117));
    ...
    public unsafe struct clr_Utf8String
    {
        ...
        public string ReadFromMemory(IntPtr address) => new string((sbyte*)address);
    }
    ...
    {
        [FieldOffset(0x00)]
        public clr_ArrayList Array; // clr_Asembly
    }

    public unsafe struct clr_DomainAssembly { }

    public unsafe struct clr_ArrayList
    {
        public int Count;

        public clr_FirstArrayListBlock FirstBlock;

        public List<IntPtr> ToList() => new ArrayListInterator(this).ToList();
    }

    [StructLayout(LayoutKind.Sequential, Pack = 0)]
    public unsafe struct clr_ArrayListBlock
    {
        public clr_ArrayListBlock* Next;
        public int BlockSize;
        int padding;

        public IntPtr GetArrayElement(int index)
        {
            fixed (clr_ArrayListBlock* pointer = &this)
                return *((IntPtr*)(pointer + 1) + index);
        }
    }

    [StructLayout(LayoutKind.Sequential, Pack = 0)]
    public unsafe struct clr_FirstArrayListBlock
    {
        ...
        public IntPtr GetArrayElement(int index)=> (IntPtr)array[index];
    }
}
